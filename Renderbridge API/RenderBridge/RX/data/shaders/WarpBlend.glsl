#include "WarpBlendColorCorrectionRT.glsl"
...
struct WarpBlend {
  ...
  mat4 color_parameters;
};

vec4 texture(WarpBlend s, vec2 tex_coords) {
  vec4 color = vec4(1);
  ...
  color_correction_realtime(color, s.color_parameters);
